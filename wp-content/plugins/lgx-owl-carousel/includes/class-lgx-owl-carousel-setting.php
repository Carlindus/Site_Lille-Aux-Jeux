...
class Lgx_Carousel_Settings_API {
	...
	function callback_textimg($args) {
		...
		//$lgxwp_image_name = $this->get_option('lgxwp_image_name', 'lgxowl_basic');
		...
		$html  = sprintf('<input type="text" class="lgxowlbg %1$s-text '.(($lgxwp_image_name != 'custom') ? ' hidden' : '').'" id="%2$s[%3$s]" name="%2$s[%3$s]" value="%4$s" placeholder="%5$s" style="float:left; "/>', $size, $args['section'], $args['id'], $value, $placeholder);
