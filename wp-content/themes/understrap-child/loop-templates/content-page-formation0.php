			...
			if( get_row_layout() == 'bloc_info_droit' ): ?>
				...
				<div class="col-sm-10 col-lg-6 m-x-sm-1  m-x-auto mt-5">
					<div class="module modLeft">
						<h3 class="h3R"><?php echo the_sub_field('bloc_info_droit_h3'); ?></h3>
...
// Bloc de type Info avec descriptif - titre à droite
		...
		if( get_row_layout() == 'bloc_info_description_droit' ): ?>
			...
			<div class="modR col-sm-10 col-lg-6 mt-5">
				<div class="module modLeft">
...
// Bloc de type Info avec descriptif - titre à gauche
	...
	if( get_row_layout() == 'bloc_info_description_gauche' ): ?>
		...
		<div class="modL col-sm-10 col-lg-6 mt-5">
			<div class="module">
...
// Bloc de type Info avec média - titre à droite
...
<div class="col-8 formule col-lg-4 d-flex flex-column align-items-center">
	...
	<div class="prix d-flex flex-column align-items-center">
		...
		<a class="hidden" href="https://www.youtube.com" data-inscrire>Je veux m'inscrire</a>
	</div>
	<div class="tabclose">
		<div>
...
<div class="">
<iframe src="<?php echo the_sub_field('bloc_iframe_url') ?>" width="<?php echo the_sub_field('bloc_iframe_width') ?>" height="<?php echo the_sub_field('bloc_iframe_height') ?>" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
